    ...
    <section class="wrapper">
        ...
        <div class="image-container">
            <div class="carousel">
                ...
                <!-- <a href="{{route('country.index', ['country_id' => 1]) }}"><img src="/images/country/lv1.svg" alt=""></a>
                <a href="{{route('country.index', ['country_id' => 2]) }}"><img src="/images/country/lv2.svg" alt=""></a>
                <a href="{{route('country.index', ['country_id' => 3]) }}"><img src="/images/country/lv3.svg" alt=""></a>
                <a href="{{route('country.index', ['country_id' => 4]) }}"><img src="/images/country/lv4.svg" alt=""></a>
                <a href="{{route('country.index', ['country_id' => 5]) }}"><img src="/images/country/lv5.svg" alt=""></a> -->
            </div>
        </div>
