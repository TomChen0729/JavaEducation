    ...
    <style>
        * {
        ...
        #gun{
            ...
            transform-origin: center left; /* 設定旋轉軸 */
        }
...
<body>
    ...
    <div class="container-fluid">
        <div class="left-container">
            <div class="game" id="game-container">
                <!-- 動畫素材 -->
                <img id="girl" src="/images/spy/jailgirl.svg">
                <img id="boy" src="/images/spy/jailboy.svg">
                <img id="man" src="/images/spy/jailman.svg">
    ...
    <script>
        ...
        function play() {
            // 間諜
            const spy = document.getElementById('man');
            const gun = document.getElementById('gun');

            gun.style.opacity = 1;
            gun.style.animation = 'animate 0.5s ease-in-out';
