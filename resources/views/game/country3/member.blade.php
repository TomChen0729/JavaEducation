    ...
    <style>
        * {
        ...
        #game-container {
            height: 70%;
            width: 100%;
            background: url('/images/member/memberbg.svg') no-repeat center;
            background-size: cover;
            /* border: 5px solid #442a0f; */
            border-radius: 30px;
            position: relative;
    ...
    <div class="container-fluid">
        <div class="left-container">
            <div class="game" id="game-container">
                <!-- 動畫素材 -->
                <img id="girl" src="/images/member/girlcard.svg">

                <img id="boy" src="/images/member/boycard.svg">
                <img id="man" src="/images/member/mancard.svg">
            </div>
