...
<head>
    ...
    <style>
        * {
        ...
        #eraser.animate {
            opacity: 1;
            animation: eraser 3s ease forwards;
        }
    ...
    <div class="container-fluid">
        <div class="left-container">
            <div class="game" id="game-container">
                <!-- 動畫素材 -->
                <img id="paper" src="/images/paper/wrongpaper.svg">

                <img id="eraser" src="/images/paper/eraser.svg">
                <img id="pen" src="/images/paper/pen.svg">
            </div>
