    ...
    <style>
        * {
        ...
        #game-container {
            height: 70%;
            width: 100%;
            background: url('/images/check/checkbg.svg') no-repeat center;
            background-size: cover;
            /* border: 5px solid #442a0f; */
            border-radius: 30px;
            position: relative;
        ...
        /* 滑出效果 */
        #ax.show {
            transform: translate(-100%, -125%) scale(1); /* 滑向左上 */
            opacity: 1;
        }

        #fire.show {
            transform: translate(0%, -125%) scale(1); /* 滑向正上 */
            opacity: 1;
        }

        #rope.show {
            transform: translate(100%, -125%) scale(1); /* 滑向右上 */
            opacity: 1;
        }
    ...
    <div class="container-fluid">
        <div class="left-container">
            <div class="game" id="game-container">
                <!-- 動畫素材 -->
                <img id="bag" src="/images/check/bag.svg">

                <img id="ax" src="/images/check/ax.svg">
                <img id="fire" src="/images/check/fire.svg">
                <img id="rope" src="/images/check/rope.svg">
            </div>
