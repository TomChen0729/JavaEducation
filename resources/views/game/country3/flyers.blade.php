    ...
    <style>
        * {
        ...
        #game-container {
            height: 70%;
            width: 100%;
            background: url('/images/flyers/flyersbg.svg') no-repeat center;
            background-size: cover;
            /* border: 5px solid #442a0f; */
            border-radius: 30px;
            position: relative;
...
<body>
    ...
    <div class="container-fluid">
        <div class="left-container">
            <div class="game" id="game-container">
                <!-- 動畫素材 -->
                <img id="safe" src="/images/flyers/safe.svg">
                <img id="safe2" src="/images/flyers/safe.svg">
            </div>
    ...
    <script>
        ...
        function play() {
            ...
            safe.src = "/images/flyers/danger.svg";
            safe2.src = "/images/flyers/danger.svg";
        }
